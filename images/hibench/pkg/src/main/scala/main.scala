...
case class Job(idd: Int, model_type: String, model_params: Map[String, String])
...
def add_logistic_regression(idd: Int, valRepetitions: Range, jobs: ListBuffer[Job]): Int = {
...
def add_kmeans(idd: Int, valRepetitions: Range, jobs: ListBuffer[Job]): Int = {
...
def add_gradient_boosted_trees(idd: Int, valRepetitions: Range, jobs: ListBuffer[Job]): Int = {
...
def add_random_forest(idd: Int, valRepetitions: Range, jobs: ListBuffer[Job]): Int = {
...
def add_decision_tree(idd: Int, valRepetitions: Range, jobs: ListBuffer[Job]): Int = {
...
def add_svm(idd: Int, valRepetitions: Range, jobs: ListBuffer[Job]): Int = {
...
def add_naive_bayes(idd: Int, valRepetitions: Range, jobs: ListBuffer[Job]): Int = {
